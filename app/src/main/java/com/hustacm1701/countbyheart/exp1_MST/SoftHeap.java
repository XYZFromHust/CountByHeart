...
public final class SoftHeap<E> {
    public SoftHeap(Comparator<? super E> comparator) {
    ...
    private static final class ElemList<E> extends AbstractCollection<E> {
         ...
         * empty.
         */
         private ElemLinkedListNode<E> head = null;
        private int size = 0;
        /**
         * Points to the last node of the linked list, or null if the list is empty.
         */
         private ElemLinkedListNode<E> tail = null;
    ...
    linkedIterator(final  Linked<T> linked) {
